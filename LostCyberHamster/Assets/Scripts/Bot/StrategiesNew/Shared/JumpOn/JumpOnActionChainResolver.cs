...
namespace Assets.Scripts.Bot.StrategiesNew.Shared.JumpOn
{
    ...
    internal sealed class JumpOnActionChainResolver
    {
            ...
            out int targetObstacleChainIndex)
        {
            ...
            targetObstacleIndex = -1;
            targetObstacleChainIndex = -1;
            var elements = new List<ObstacleChainElementNew>(sourceChain.Elements);
            ...
            for (int obstacleIndex = scanStartIndex; obstacleIndex < worldSnapshot.Obstacles.Count; obstacleIndex++)
            {
                ...
                actionChain = new ObstacleChainNew(elements);
                targetObstacle = element.Obstacle;
                targetObstacleIndex = element.WorldIndex;
            ...
            out ObstacleChainElementNew element)
        {
            ...
            HashSet<ObstacleRole> roles = ObstacleRoleClassifierNew.GetRoles(
                ...
                worldSnapshot,
                obstacle);
            var candidate = new ObstacleChainElementNew(obstacle, obstacleIndex, roles);
        ...
        /// </summary>
        private static bool IsGroundTarget(ObstacleChainElementNew element)
        {
            return element != null
