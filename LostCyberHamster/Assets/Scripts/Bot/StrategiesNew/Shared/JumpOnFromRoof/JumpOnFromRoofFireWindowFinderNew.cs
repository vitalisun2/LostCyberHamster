...
namespace Assets.Scripts.Bot.StrategiesNew.Shared.JumpOnFromRoof
{
    ...
    /// </summary>
    internal sealed class JumpOnFromRoofFireWindowFinderNew
    {
        /// <summary>
        ...
        public JumpOnFromRoofFireWindowFinderNew(IJumpOnFromRoofPolicy policy)
        {
            _policy = policy;
        }
            ...
            out IReadOnlyList<float> fireShifts)
        {
            ...
            fireShifts = null;
            if (!JumpOnFromRoofWindowCalculatorNew.TryCalculate(
