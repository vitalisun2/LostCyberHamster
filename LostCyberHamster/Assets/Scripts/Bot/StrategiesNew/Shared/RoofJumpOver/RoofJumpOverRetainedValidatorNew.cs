...
namespace Assets.Scripts.Bot.StrategiesNew.Shared.RoofJumpOver
{
    ...
    /// </summary>
    internal sealed class RoofJumpOverRetainedValidatorNew : IRetainedActionValidatorNew
    {
        /// <summary>
        ...
        /// </summary>
        public RoofJumpOverRetainedValidatorNew(
            IRoofJumpOverPolicy policy,
            RoofJumpOverFireWindowFinderNew fireWindowFinder,
            RoofJumpOverSpecificationNew specification)
        {
            _policy = policy;
        ...
        public bool IsStillValid(RetainedActionContextNew context)
        {
            ...
            if (!_policy.TryGetTravel(out RoofJumpOverTravel travel)
                || !TryBuildRoofHazardChain(context, out ObstacleChainNew sourceChain))
            {
                return false;
            }
