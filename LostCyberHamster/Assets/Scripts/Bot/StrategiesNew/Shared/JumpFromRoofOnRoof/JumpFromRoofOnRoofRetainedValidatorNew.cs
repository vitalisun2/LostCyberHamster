...
namespace Assets.Scripts.Bot.StrategiesNew.Shared.JumpFromRoofOnRoof
{
    ...
    /// </summary>
    internal sealed class JumpFromRoofOnRoofRetainedValidatorNew : IRetainedActionValidatorNew
    {
        /// <summary>
        ...
        /// </summary>
        private readonly JumpFromRoofOnRoofFireWindowFinderNew _fireWindowFinder;

        /// <summary>
        /// Specification применимости сохраненного roof-to-roof action.
        /// </summary>
        private readonly JumpFromRoofOnRoofSpecificationNew _specification;
        ...
        public JumpFromRoofOnRoofRetainedValidatorNew(
            IJumpFromRoofOnRoofPolicy policy,
            JumpFromRoofOnRoofFireWindowFinderNew fireWindowFinder,
            JumpFromRoofOnRoofSpecificationNew specification)
        {
            _policy = policy;
        ...
        public bool IsStillValid(RetainedActionContextNew context)
        {
            ...
            if (!TryBuildBlockerChain(planningState, projectedWorldSnapshot, out ObstacleChainNew chain))
                return false;
