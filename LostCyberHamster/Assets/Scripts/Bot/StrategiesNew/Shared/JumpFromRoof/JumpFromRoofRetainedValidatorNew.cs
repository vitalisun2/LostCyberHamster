...
namespace Assets.Scripts.Bot.StrategiesNew.Shared.JumpFromRoof
{
    ...
    /// </summary>
    internal sealed class JumpFromRoofRetainedValidatorNew : IRetainedActionValidatorNew
    {
        ...
        /// </summary>
        public JumpFromRoofRetainedValidatorNew(
            IJumpFromRoofPolicy policy,
            JumpFromRoofFireWindowFinderNew fireWindowFinder,
            JumpFromRoofSpecificationNew specification)
        {
            _policy = policy;
        ...
        public bool IsStillValid(RetainedActionContextNew context)
        {
            ...
            if (!_policy.TryGetTravel(out JumpFromRoofTravel travel)
                || !TryBuildRoofExitChain(context, out ObstacleChainNew sourceChain))
            {
                return false;
            }
            ...
            if (!JumpFromRoofChainCalculatorNew.TryCalculate(
                    _policy,
                    context.PlanningState,
                    sourceChain,
                    lastRoof,
