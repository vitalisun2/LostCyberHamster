...
namespace Assets.Scripts.Bot.StrategiesNew.SuperJumpFromRoofOnRoof
{
    ...
    /// </summary>
    internal sealed class SuperJumpFromRoofOnRoofStrategyNew : IPlanningStrategyNew
    {
        /// <summary>
        ...
        public SuperJumpFromRoofOnRoofStrategyNew()
        {
            // Инициализирует зависимости стратегии.
            _policy = new SuperJumpFromRoofOnRoofPolicy();
            _specification = new JumpFromRoofOnRoofSpecificationNew(_policy);
            _fireWindowFinder = new JumpFromRoofOnRoofFireWindowFinderNew(_policy);
            ...
            RetainedValidator = new JumpFromRoofOnRoofRetainedValidatorNew(
                _policy,
                _fireWindowFinder,
                _specification);
        }
