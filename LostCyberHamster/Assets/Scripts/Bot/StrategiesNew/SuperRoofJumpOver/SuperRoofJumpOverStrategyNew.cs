...
using Assets.Scripts.Bot.StrategiesNew.Shared.RoofJumpOver;
...
namespace Assets.Scripts.Bot.StrategiesNew.SuperRoofJumpOver
{
    ...
    /// </summary>
    internal sealed class SuperRoofJumpOverStrategyNew : IPlanningStrategyNew
    {
        /// <summary>
        ...
        /// </summary>
        private readonly RoofJumpOverSpecificationNew _specification;
        ...
        /// </summary>
        private readonly RoofJumpOverFireWindowFinderNew _fireWindowFinder;
        ...
        /// </summary>
        public SuperRoofJumpOverStrategyNew()
        {
            _policy = new SuperRoofJumpOverPolicy();
            _specification = new RoofJumpOverSpecificationNew(_policy);
            _actionResolver = new RoofJumpOverActionResolver();
            _fireWindowFinder = new RoofJumpOverFireWindowFinderNew(_policy);
            _simulator = new RoofJumpOverSimulator(_policy);
            var triggerGate = new ActionTriggerGate(new LiveObstacleResolver());

            Executor = new SuperRoofJumpOverExecutor(triggerGate);
            Simulator = _simulator;
            RetainedValidator = new RoofJumpOverRetainedValidatorNew(
                _policy,
                _fireWindowFinder,
                _specification);
        }
