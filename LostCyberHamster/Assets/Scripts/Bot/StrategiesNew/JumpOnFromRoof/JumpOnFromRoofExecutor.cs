...
namespace Assets.Scripts.Bot.StrategiesNew.JumpOnFromRoof
{
    /// <summary>
    /// Выполняет ordinary roof-to-road jump-on в runtime.
    /// </summary>
    internal sealed class JumpOnFromRoofExecutor : IActionExecutionHandler
    {
        /// <summary>
        ...
        public JumpOnFromRoofExecutor(ActionTriggerGate triggerGate)
        {
            _triggerGate = triggerGate;
        }

        /// <summary>
        /// Пытается выполнить roof jump request для напрыгивания на дорожный target.
        /// </summary>
        public ActionFireResult TryFire(Hamster hamster, PlannedAction action)
        {
            ...
            if (action.Kind != BotActionKind.JumpOnFromRoof || !action.TargetObstacleInstanceId.HasValue)
        ...
        /// <summary>
        /// Проверяет завершение roof-to-road jump-on возвратом в Run.
        /// </summary>
