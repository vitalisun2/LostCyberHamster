...
using Assets.Scripts.Bot.StrategiesNew.Shared.JumpOnFromRoof;
...
namespace Assets.Scripts.Bot.StrategiesNew.JumpOnFromRoof
{
    ...
    /// </summary>
    internal sealed class JumpOnFromRoofStrategyNew : IPlanningStrategyNew
    {
        /// <summary>
        ...
        public JumpOnFromRoofStrategyNew()
        {
            // Инициализирует planning-компоненты стратегии.
            _policy = new JumpOnFromRoofPolicy();
            _specification = new JumpOnFromRoofSpecificationNew(_policy);
            _actionResolver = new JumpOnFromRoofActionResolver();
            _fireWindowFinder = new JumpOnFromRoofFireWindowFinderNew(_policy);
            ...
            RetainedValidator = new JumpOnFromRoofRetainedValidatorNew(
                _policy,
                _fireWindowFinder,
                _specification);
        }
