...
{
    /// <summary>
    /// Стратегия JumpOnTarget: напрыгивание на alive врага (smallAlive).
    /// Skeleton реализация — пока возвращает "not implemented".
    /// </summary>
    public class JumpOnTargetStrategy : IActionStrategy
    {
        public BotAction Action => BotAction.JumpOnTarget;
