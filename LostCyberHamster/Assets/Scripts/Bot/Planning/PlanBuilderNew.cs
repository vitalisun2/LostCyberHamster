...
namespace Assets.Scripts.Bot.Planning
{
    ...
    /// </summary>
    public sealed class PlanBuilderNew
    {
        private const int InProgressAtomicActionCount = 1;

        private readonly PlanningGraphBuilderNew _graphBuilder;
        private readonly TransitionSimulatorNew _transitionSimulator;
        private readonly PlanEvaluator _planEvaluator;
        private readonly RetainedActionRevalidatorNew _retainedActionRevalidator;
        private readonly ActionInProgressProjectorNew _inProgressProjector;

        /// <summary>
        /// Создает role-based сборщик плана поверх generator, simulator и evaluator.
        /// </summary>
        public PlanBuilderNew(
            ActionGeneratorNew actionGenerator,
            TransitionSimulatorNew transitionSimulator,
            PlanEvaluator planEvaluator,
            RetainedActionRevalidatorNew retainedActionRevalidator,
            ActionInProgressProjectorNew inProgressProjector)
        {
            _graphBuilder = new PlanningGraphBuilderNew(actionGenerator, transitionSimulator);
