...
{
    /// <summary>
    /// Собирает действия super-прыжка с крыши через дорожные obstacles.
    /// </summary>
    internal sealed class SuperJumpFromRoofStrategy : IPlanningStrategy
    {
        /// <summary>
        /// Хранит runtime-отличия super-прыжка с крыши.
        /// </summary>
        ...
        /// <summary>
        /// Добавляет возможный super-прыжок с крыши в список planned actions.
        /// </summary>
