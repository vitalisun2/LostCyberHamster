...
namespace Assets.Scripts.Bot.Strategies.SuperJumpFromRoof
{
    ...
    internal sealed class SuperJumpFromRoofStrategy : IPlanningStrategy
    {
        ...
        /// <summary>
        /// Быстро проверяет roof-run ситуацию с дорожной угрозой для super-прыжка с крыши.
        /// </summary>
            ...
            DecisionPoint decisionPoint)
        {
            ...
            if (planningState.Hamster.Energy < _policy.EnergyCost)
            {
                return PlanningStrategyResult.InsufficientEnergy(
                    nameof(SuperJumpFromRoofStrategy),
                    _policy.ActionKind,
                    _policy.EnergyCost,
        ...
        /// <summary>
        /// Создает dead-end результат для применимой super-jump-from-roof strategy.
        /// </summary>
        private static PlanningStrategyResult DeadEnd(string message)
        {
            return PlanningStrategyResult.DeadEnd(nameof(SuperJumpFromRoofStrategy), message);
        }
