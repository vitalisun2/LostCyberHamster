...
{
    /// <summary>
    /// Вычисляет fire-window для roof-to-road jump-on по runtime-условию попадания центра хомяка в target.
    /// </summary>
    internal static class JumpOnFromRoofWindowCalculator
    {
        ...
        /// <summary>
        /// Вычисляет fire-window для первого roof jump-on target в chain.
        /// </summary>
            ...
            out float lastFireShift)
        {
            ...
            // Применяет дополнительные ограничения.
