...
namespace Assets.Scripts.Bot.Strategies.Shared.JumpOver
{
    ...
    /// </summary>
    internal sealed class JumpOverRetainedValidator : IRetainedActionValidator
    {
        ...
        /// </summary>
        public JumpOverRetainedValidator(
        ...
        public bool IsStillValid(RetainedActionContext context)
        {
            ...
            if (!TryBuildCurrentLaneChain(context, out ObstacleChain chain))
                return false;
