...
namespace Assets.Scripts.Bot.Strategies.JumpOnFromRoof
{
    ...
    internal sealed class JumpOnFromRoofStrategy : IPlanningStrategy
    {
        ...
        /// <summary>
        /// Быстро проверяет roof-run context перед поиском roof-to-road target.
        /// </summary>
        ...
        /// <summary>
        /// Создает dead-end результат для применимой jump-on-from-roof strategy.
        /// </summary>
        private static PlanningStrategyResult DeadEnd(string message)
        {
            return PlanningStrategyResult.DeadEnd(nameof(JumpOnFromRoofStrategy), message);
        }
