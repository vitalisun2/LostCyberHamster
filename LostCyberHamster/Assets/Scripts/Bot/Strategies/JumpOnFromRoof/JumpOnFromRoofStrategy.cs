...
{
    /// <summary>
    /// Собирает ordinary roof-to-road jump-on actions.
    /// </summary>
    internal sealed class JumpOnFromRoofStrategy : IPlanningStrategy
    {
        /// <summary>
        /// Политика runtime-параметров ordinary roof-to-road jump-on.
        /// </summary>
        private readonly IJumpOnFromRoofPolicy _policy;

        /// <summary>
        /// Проверка применимости ordinary roof-to-road jump-on к найденной road target-chain.
        /// </summary>
        private readonly JumpOnFromRoofSpecification _specification;

        /// <summary>
        /// Подбор безопасного момента запуска ordinary roof-to-road jump-on.
        /// </summary>
        private readonly JumpOnFromRoofFireWindowFinder _fireWindowFinder;

        /// <summary>
        /// Симулятор planning-состояния после ordinary roof-to-road jump-on.
        /// </summary>
        ...
        /// <summary>
        /// Runtime-исполнитель ordinary roof-to-road jump-on.
        /// </summary>
        public IActionExecutionHandler Executor { get; }

        /// <summary>
        /// Валидатор сохранённого ordinary roof-to-road jump-on action.
        /// </summary>
        public IRetainedActionValidator RetainedValidator { get; }

        /// <summary>
        /// Симулятор planning-перехода для ordinary roof-to-road jump-on.
        /// </summary>
        ...
        /// <summary>
        /// Создаёт planning action для ordinary roof-to-road jump-on.
        /// </summary>
