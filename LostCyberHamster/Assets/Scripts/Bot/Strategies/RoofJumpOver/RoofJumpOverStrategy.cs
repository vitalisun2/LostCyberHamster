...
namespace Assets.Scripts.Bot.Strategies.RoofJumpOver
{
    ...
    internal sealed class RoofJumpOverStrategy : IPlanningStrategy
    {
        ...
        /// <summary>
        /// Создает dead-end результат для применимой roof-jump-over strategy.
        /// </summary>
        private static PlanningStrategyResult DeadEnd(string message)
        {
            return PlanningStrategyResult.DeadEnd(nameof(RoofJumpOverStrategy), message);
        }
