...
{
    /// <summary>
    /// Собирает role-based кандидаты ground super-jump-on.
    /// </summary>
    internal sealed class SuperJumpOnStrategy : IPlanningStrategy
    {
        ...
        /// <summary>
        /// Создает strategy и runtime-компоненты super-jump-on.
        /// </summary>
        ...
        /// <summary>
        /// Создает dead-end результат для применимой super-jump-on strategy.
        /// </summary>
        private static PlanningStrategyResult DeadEnd(string message)
        {
            return PlanningStrategyResult.DeadEnd(nameof(SuperJumpOnStrategy), message);
        }
            ...
            float completionWorldShift)
        {
            ...
            // Создаёт action без локального сравнения с обычным вариантом.
