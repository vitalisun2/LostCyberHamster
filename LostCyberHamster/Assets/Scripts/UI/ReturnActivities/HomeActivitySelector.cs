...
namespace LostCyberHamster.UI
{
    ...
    internal static class HomeActivitySelector
    {
        ...
        {
            string day = ActivityDayPolicy.Day(utc);
            ...
            if (state.LastCreditedDay == day)
                return ActivityUiText.Get("home_day_done", state.Step, ActivityUiText.NextReset(utc));
        ...
        public static string Week(ReturnActivityState state, DateTime utc)
        {
            ...
            if (week.Completed) return ActivityUiText.Get("home_week_done", ActivityUiText.WeekDeadline(utc));
        ...
        public static bool WeekFirst(ReturnActivityState state, DateTime utc)
        {
            ...
            int nextDays = week.Days.Count + (week.Days.Contains(ActivityDayPolicy.Day(utc)) ? 0 : 1);
