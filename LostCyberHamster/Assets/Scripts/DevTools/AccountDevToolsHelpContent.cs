...
namespace Assets.Scripts.DevTools
{
    ...
    internal static class AccountDevToolsHelpContent
    {
        ...
        private static readonly string[] _texts =
        {
            ...
            "Так один и тот же Player ID можно восстановить после перезапуска, переустановки или на другом устройстве.\n\n" +
            ...
            "Шаг 1 — нажать «Обеспечить UGS-сессию».\n" +
            ...
            "«Обеспечить UGS-сессию» — восстанавливает cached UGS player; если кэша нет, создаёт нового гостя.\n\n" +
            ...
            "«Очистить cached identity» — удаляет локальные UGS credentials. Следующий guest-вход создаст новый Player ID. Игровые данные этим не очищаются.",
