...
1. Реализуй минимальное полное изменение в task-worktree.
2. Провалидируй только релевантное по `docs/rules/code_conventions.md`.
3. Если проверка упала по текущей задаче — исправь в task-worktree; если причина внешняя — остановись с блокером.
