...
- Агент сам выполняет только автоматизированные static/compile/package/csproj/meta/diff-проверки. Ручную проверку поведения, Play Mode, UI, test level и computer-use validation не запускать и не имитировать.
