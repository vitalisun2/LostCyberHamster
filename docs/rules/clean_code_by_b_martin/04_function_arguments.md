...
Аргументы усложняют понимание функции. Особенно опасны boolean-флаги, выходные аргументы и длинные списки параметров: они часто означают, что функция делает несколько разных вещей или скрывает недостающую концепцию.
