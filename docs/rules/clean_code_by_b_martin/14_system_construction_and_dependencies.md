...
Если класс одновременно строит зависимости и выполняет игровой сценарий, раздели construction и use. Это почти всегда снижает связность и упрощает сопровождение.
